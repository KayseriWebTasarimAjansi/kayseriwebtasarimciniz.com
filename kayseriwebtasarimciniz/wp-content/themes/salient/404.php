		...
		<div class="row">
			...
			<div class="col span_12">
				...
				<div id="error-404" <?php if(!empty($page_404_font_color)) { echo 'data-cc="true" style="color: '.$page_404_font_color.';"'; } ?> >
					<h1>404</h1>
					<h2><?php echo __('Sayfa Bulunamadı', 'salient'); ?></h2>
					
					<?php if($page_404_home_button == '1') { ?>
						   <a class="nectar-button large regular-button accent-color has-icon" data-color-override="false" data-hover-color-override="false" href="<?php echo home_url(); ?>"><span><?php echo __('Anasayfaya git', 'salient'); ?> </span><i class="icon-button-arrow"></i></a>
					 <?php } ?>
				</div>
