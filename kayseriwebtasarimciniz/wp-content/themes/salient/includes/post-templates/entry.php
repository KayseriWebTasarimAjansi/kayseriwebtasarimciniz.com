					...
					if ( has_post_thumbnail() ) {
		 				 ...
		 				 if( !is_single() ) {
							...
							if($using_masonry == true && $masonry_type == 'auto_meta_overlaid_spaced') {
								...
								echo'<a href="' . get_permalink() . '"><span class="post-featured-img">'.get_the_post_thumbnail($post->ID, $img_size, $image_attrs) .'</span></a>'; 
							}
						...
						<div class="article-content-wrap">
							...
							<div class="post-header">
								...
								<?php if(!($masonry_type == 'classic_enhanced' && $using_masonry == true) &&  !($using_masonry == true && $masonry_type == 'material') ) { ?> 
									<span class="meta-author"><span><?php echo __(' ', 'salient'); ?></span> <?php the_author_posts_link(); ?></span> <span class="meta-category">| <?php the_category(', '); ?></span> 
